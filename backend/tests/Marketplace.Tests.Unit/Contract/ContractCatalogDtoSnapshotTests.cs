...
public sealed class ContractCatalogDtoSnapshotTests
{
    ...
    public void Contract_ProductSearchResultDto_Snapshot_Matches()
    {
        var item = new ProductListItemDto(
            ...
            DateTime.UnixEpoch,
            DateTime.UnixEpoch,
            ["https://cdn.test/keyboard.png"]);
        var dto = new ProductSearchResultDto([item], 1, 1, 20, "cursor");

        var json = JsonSerializer.Serialize(dto);
        const string expected = "{\"Items\":[{\"Id\":10,\"CompanyId\":\"11111111-1111-1111-1111-111111111111\",\"Name\":\"Keyboard\",\"Slug\":\"keyboard\",\"Description\":\"RGB keyboard\",\"Price\":199,\"OldPrice\":null,\"DiscountPercent\":null,\"CategoryId\":1,\"Status\":\"active\",\"HasVariants\":false,\"Stock\":10,\"MinStock\":1,\"AvailableQty\":9,\"AvailabilityStatus\":\"in_stock\",\"CreatedAt\":\"1970-01-01T00:00:00Z\",\"UpdatedAt\":\"1970-01-01T00:00:00Z\",\"ImageUrls\":[\"https://cdn.test/keyboard.png\"]}],\"Total\":1,\"Page\":1,\"PageSize\":20,\"NextSearchAfter\":\"cursor\"}";
        Assert.Equal(expected, json);
    }
}
