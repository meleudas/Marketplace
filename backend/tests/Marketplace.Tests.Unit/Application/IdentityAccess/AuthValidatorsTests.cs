...
public class AuthValidatorsTests
{
    ...
    {
        var validator = new Marketplace.Application.Auth.Commands.Register.RegisterCommandValidator();
        var command = new Marketplace.Application.Auth.Commands.Register.RegisterCommand("user@example.com", "weakpass", "user_name", null);
    ...
    [Fact]
    public void ResetPasswordValidator_Rejects_Weak_Password()
    {
        var validator = new ResetPasswordCommandValidator();
        var command = new ResetPasswordCommand("user@example.com", "token", "weakpass");
