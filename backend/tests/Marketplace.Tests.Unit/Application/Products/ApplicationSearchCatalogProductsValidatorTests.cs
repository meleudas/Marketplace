...
public sealed class ApplicationSearchCatalogProductsValidatorTests
{
    ...
    {
        var result = _validator.Validate(new SearchCatalogProductsQuery(null, null, null, null, null, null, null, null, 0, 20, null));
    ...
    {
        var result = _validator.Validate(new SearchCatalogProductsQuery(null, null, null, null, null, null, null, null, 1, 150, null));
    ...
    {
        var result = _validator.Validate(new SearchCatalogProductsQuery(null, null, null, null, 100, 10, null, null, 1, 20, null));
