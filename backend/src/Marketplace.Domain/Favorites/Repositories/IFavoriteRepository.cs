...
public interface IFavoriteRepository
{
    ...
    Task<Favorite?> GetByUserAndProductIncludingDeletedAsync(Guid userId, ProductId productId, CancellationToken ct = default);
    ...
    Task ReactivateAsync(FavoriteId id, DateTime utcNow, Money? priceAtAdd, CancellationToken ct = default);
