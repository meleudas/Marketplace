...
Файли з **прикладами JSON body** для швидкого копіювання в Postman/curl.  
**Повний опис** кожного endpoint-а (відповіді, авторизація, side effects, помилки) — у канонічному довіднику:

- [Довідник endpoint-ів](../Endpoints/README.md)
- [Матриця ролей](../DDD/RoleAccessMatrix.md)

## Відповідність файл → детальна документація

| Приклади body | Довідник маршрутів |
|---------------|-------------------|
| [AuthController.md](AuthController.md) | [Endpoints/Auth.md](../Endpoints/Auth.md) |
| [ExternalAuthController.md](ExternalAuthController.md) | [Endpoints/ExternalAuth.md](../Endpoints/ExternalAuth.md) |
| [AccountController.md](AccountController.md) | [Endpoints/Account.md](../Endpoints/Account.md) |
