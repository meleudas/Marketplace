...
public static class DependencyInjection
{
    public static IServiceCollection AddApplication(this IServiceCollection services)
    {
        ...
        services.AddScoped<CreateRateLimitPolicy>();
        services.AddScoped<SupportAntiAbusePolicy>();
        services.AddScoped<ReviewCreateAntiAbusePolicy>();
        services.AddScoped<PaymentWebhookAntiAbusePolicy>();
        services.AddScoped<NotificationDispatchAntiAbusePolicy>();
