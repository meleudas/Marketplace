...
namespace Marketplace.Application.Returns.Commands.MarkReturnReceived;

public sealed record MarkReturnReceivedCommand(long ReturnId, Guid CompanyId, Guid ActorUserId, bool IsActorAdmin) : IRequest<Result<ReturnRequestDetailDto>>;

public sealed class MarkReturnReceivedCommandHandler : IRequestHandler<MarkReturnReceivedCommand, Result<ReturnRequestDetailDto>>
{
    ...
    public async Task<Result<ReturnRequestDetailDto>> Handle(MarkReturnReceivedCommand request, CancellationToken ct)
    {
